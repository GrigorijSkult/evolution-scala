...
import homeworks.basics.Task6.SuperVipCollections4s._
import homeworks.basics.Task6.SuperVipCollections4s.syntax._
import homeworks.basics.ImplicitsHomeworkSpec.TestValue
import org.scalatest.freespec.AnyFreeSpec
import org.scalatest.matchers.should.Matchers

class Task6Test extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import homeworks.basics.Task6.SuperVipCollections4s.instances._
          |import homeworks.basics.Task6.SuperVipCollections4s.syntax._
          |
  ...
  "TwitCache" - {
    import homeworks.basics.Task6.MyTwitter._
